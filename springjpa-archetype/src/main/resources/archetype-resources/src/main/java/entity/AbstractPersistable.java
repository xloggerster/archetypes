 ...
 * {@link ${symbol_pound}hashCode()} based on that id.
 * 
...
public abstract class AbstractPersistable<PK extends Serializable> implements
     ...
     * (non-Javadoc)
     * 
     * @see org.springframework.data.domain.Persistable${symbol_pound}getId()
     */
    @Override
	public PK getId() {
     ...
     * (non-Javadoc)
     * 
     * @see org.springframework.data.domain.Persistable${symbol_pound}isNew()
     */
    @Override
