...
public class FormSubmitService {
	...
	public ExtDirectFormPostResult handleFormSubmit(FormBean bean, MultipartFile screenshot) {
		...
		String resultString = "Server received: ${symbol_escape}n" + bean.toString();
		resultString += "${symbol_escape}n";

		if (!screenshot.isEmpty()) {
			resultString += "ContentType: " + screenshot.getContentType() + "${symbol_escape}n";
			resultString += "Size: " + screenshot.getSize() + "${symbol_escape}n";
